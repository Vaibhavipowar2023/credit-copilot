  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-900 to-blue-800 px-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <h1 className="text-2xl font-bold text-brand-900 mb-1">Credit & Covenant</h1>
        <p className="text-gray-500 text-sm mb-6">Risk Copilot — sign in to continue</p>
